  ...
  return (
    <div className="bg-[var(--color-bg-surface)] rounded-xl border border-gray-200 p-6">
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-xs text-[var(--color-text-primary)] font-medium mb-1">{t('settings.mainCurrency')}</label>
          <div className="relative">
            <input
              type="text"
              value={config.currencyLabel}
              readOnly
              className="w-full bg-[var(--color-bg-page)] border border-gray-200 rounded-lg px-4 py-2 text-sm text-gray-700 pr-8"
            />
        ...
        <div>
          ...
          <div className="bg-[var(--color-bg-page)] border border-gray-200 rounded-lg px-4 py-2 flex justify-between items-center">
