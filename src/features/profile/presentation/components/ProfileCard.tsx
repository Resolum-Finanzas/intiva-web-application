  ...
  <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
    <div className="flex flex-col items-center">
      <div className="relative">
        <div className="w-24 h-24 rounded-full bg-[#1A237E] flex items-center justify-center text-white text-2xl font-bold">
          {profile.avatarUrl ? (
        ...
        <div className="absolute bottom-0 right-0 bg-[#1A237E] text-white w-6 h-6 rounded-full flex items-center justify-center p-1">
          <Camera size={12} />
        </div>
      </div>
      ...
      <div className="mt-3 bg-[#E8EAF6] text-[#1A237E] text-xs px-3 py-1 rounded-full font-medium">
    ...
    {profile.creditStatus && (
      <div className="mt-6 pt-4 border-t border-gray-100">
        ...
        <div className="mt-2 bg-[#E8F5E9] rounded-lg px-4 py-3 flex items-center gap-2">
